              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: '12px' }}>
                  {prod.skus.map((sku, i) => {
                    ...
                    const skuStock = sku.inventory ? (Array.isArray(sku.inventory) ? sku.inventory.reduce((acc, inv) => acc + (inv.quantity_available || 0), 0) : (sku.inventory.quantity_available || 0)) : 0;
