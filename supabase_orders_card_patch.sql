-- Update admin_get_orders to return items and shipments as JSON directly

DROP FUNCTION IF EXISTS admin_get_orders(TEXT, TEXT, TEXT, INT, INT);
...
-- Reload PostgREST schema cache so the new columns are available immediately
